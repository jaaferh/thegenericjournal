...
const routes: Routes = [
      ...
      resolve: {posts: PostListResolver} },
  {
    ...
    children: [
      ...
      { path: 'author/new', canActivate: [ AuthGuard ], component: AuthorFormComponent },
      { path: 'author/:id', component: AuthorDetailComponent,
          resolve: {authorDetail: AuthorDetailResolver} },
      { path: 'author/:id/edit', canActivate: [ AuthGuard ], component: AuthorFormComponent,
          resolve: {authorDetail: AuthorDetailResolver} },
      ...
      { path: 'post/new', canActivate: [ AuthGuard ], component: PostFormComponent,
          resolve: {topics: TopicListResolver, authors: AuthorListResolver} },
      { path: 'post/:id', component: PostDetailComponent,
          resolve: {post: PostDetailResolver} },
      { path: 'post/:id/edit', canActivate: [ AuthGuard ], component: PostFormComponent,
